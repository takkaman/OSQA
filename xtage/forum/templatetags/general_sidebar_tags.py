...
from forum.models import Tag, Award, Space
from forum import settings
from forum.views import admin
...
@register.inclusion_tag('sidebar/recent_stats.html')
def recent_stats():
    return {'statistics': admin.get_statistics()}

@register.inclusion_tag('sidebar/show_spaces.html')
def show_spaces():

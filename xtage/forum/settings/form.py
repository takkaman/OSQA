...
""" settings for invites """
FORM_MIN_NUMBER_OF_INVITES = Setting('FORM_MIN_NUMBER_OF_INVITES', -1, FORUM_SET, dict(
label = _("Required number of invites per question"),
help_text = _("How many invites are required in questions."),
))

FORM_MAX_NUMBER_OF_INVITES = Setting('FORM_MAX_NUMBER_OF_INVITES', 10, FORUM_SET, dict(
label = _("Maximum number of invites per question"),
help_text = _("How many invites are allowed in questions."),
))

FORM_MIN_LENGTH_OF_INVITE = Setting('FORM_MIN_LENGTH_OF_INVITE', 1, FORUM_SET, dict(
label = _("Minimum length of an invite"),
help_text = _("How short an invite can be."),
))

FORM_MAX_LENGTH_OF_INVITE = Setting('FORM_MAX_LENGTH_OF_INVITE', 20, FORUM_SET, dict(
label = _("Maximum length of an invite"),
help_text = _("How long an invite can be."),
))

            ...
            if (data) {
                ...
                for (var skill in data) {
                    ...
                    for (var i = 0; i < (data[skill]).length; i++) {
                        var item = user_template.replace(new RegExp('%USERID%', 'g'), data[skill][i][0])
                                            .replace(new RegExp('%FULLNAME%', 'g'), data[skill][i][1])
                                            .replace(new RegExp('%SCORE%', 'g'), data[skill][i][2]);
                        users += item;
                    }

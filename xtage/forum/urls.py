...
core_urls = (
    ...
    url(r'^%s(?P<path>.*)$' % _('userface/'), 'django.views.static.serve', {'document_root': os.path.join(APP_PATH, 'upface').replace('\\', '/')}, name='uploaded_face',),
    ...
    url(r'^%s%s(?P<space_id>\d+)' % (_('questions/'), _('ask/')), app.writers.ask, name='ask'),
    url(r'^%s%s$' % (_('questions/'), _('related_questions/')), app.commands.related_questions, name='related_questions'),
    url(r'^%s%s$' % (_('questions/'), _('related_users/')), app.commands.related_users, name='related_users'),
    ...
    url(r'^%s(?P<id>\d+)/$' % _('adore_skill/'), app.commands.adore_skill, name='adore_skill'),
    ...
    url(r'^%s' % _('matching_username/'), app.commands.matching_username, name='matching_username'),
    ...
    url(r'^%s(?P<id>\d+)/(?P<slug>.*)$' % _('space/'), app.readers.space, name='space'),
    ...
    url(r'^%s$' % _('skills/'), app.users.skills, name='skills'),
	...
	#syl added
	url(r'^%s(?P<id>\d+)/%s$' % (_('users/'), _('add_skill/')), app.users.add_skill, name='add_skill'),
	url(r'^%s(?P<id>\d+)/%s$' % (_('users/'), _('remove_skill/')), app.users.remove_skill, name='remove_skill'),
    url(r'^%s$' % (_('ajax_skill_search/')), app.users.ajax_skill_search, name='ajax_skill_search'),

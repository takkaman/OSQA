...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Skill.last_update_at'
        db.add_column(u'forum_skill', 'last_update_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Skill.popularity'
        db.add_column(u'forum_skill', 'popularity',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Skill.last_update_at'
        db.delete_column(u'forum_skill', 'last_update_at')

        # Deleting field 'Skill.popularity'
        db.delete_column(u'forum_skill', 'popularity')
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 26, 0, 0)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 27, 0, 0)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.img'
        db.add_column(u'forum_user', 'img',
                      self.gf('django.db.models.fields.files.ImageField')(default='upload_userface/noface.gif', max_length=100),
                      keep_default=False)

        # Adding field 'User.imgset'
        db.add_column(u'forum_user', 'imgset',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.img'
        db.delete_column(u'forum_user', 'img')

        # Deleting field 'User.imgset'
        db.delete_column(u'forum_user', 'imgset')
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 17, 0, 0)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 18, 0, 0)'}),

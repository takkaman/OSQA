...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NodeRevision.public'
        db.add_column(u'forum_noderevision', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field whitelist on 'NodeRevision'
        m2m_table_name = db.shorten_name(u'forum_noderevision_whitelist')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('noderevision', models.ForeignKey(orm['forum.noderevision'], null=False)),
            ('user', models.ForeignKey(orm['forum.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['noderevision_id', 'user_id'])


    def backwards(self, orm):
        # Deleting field 'NodeRevision.public'
        db.delete_column(u'forum_noderevision', 'public')

        # Removing M2M table for field whitelist on 'NodeRevision'
        db.delete_table(db.shorten_name(u'forum_noderevision_whitelist'))
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 29, 0, 0)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 30, 0, 0)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Space'
        db.create_table(u'forum_space', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('space_name', self.gf('django.db.models.fields.CharField')(default='General', max_length=64)),
        ))
        db.send_create_signal('forum', ['Space'])

        # Adding field 'NodeRevision.space'
        db.add_column(u'forum_noderevision', 'space',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='access_noderevisions', to=orm['forum.Space']),
                      keep_default=False)

        # Adding field 'Node.space'
        db.add_column(u'forum_node', 'space',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='access_nodes', to=orm['forum.Space']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Space'
        db.delete_table(u'forum_space')

        # Deleting field 'NodeRevision.space'
        db.delete_column(u'forum_noderevision', 'space_id')

        # Deleting field 'Node.space'
        db.delete_column(u'forum_node', 'space_id')
    ...
    models = {
        ...
        'forum.node': {
            ...
            'space': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'access_nodes'", 'to': "orm['forum.Space']"}),
        ...
        'forum.noderevision': {
            ...
            'space': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'access_noderevisions'", 'to': "orm['forum.Space']"}),
        ...
        'forum.questionsubscription': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 6, 6, 0, 0)'}),
        ...
        'forum.space': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'space_name': ('django.db.models.fields.CharField', [], {'default': "'General'", 'max_length': '64'})
        },
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 6, 7, 0, 0)'}),

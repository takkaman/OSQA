...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Skillownership.adore_num'
        db.add_column(u'forum_skillownership', 'adore_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Skillownership.adore_num'
        db.delete_column(u'forum_skillownership', 'adore_num')
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 9, 11, 0, 0)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 9, 12, 0, 0)'}),

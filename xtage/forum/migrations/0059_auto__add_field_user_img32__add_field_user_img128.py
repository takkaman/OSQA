...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.img32'
        db.add_column(u'forum_user', 'img32',
                      self.gf('django.db.models.fields.files.ImageField')(default='upload_userface/noface_32.gif', max_length=100),
                      keep_default=False)

        # Adding field 'User.img128'
        db.add_column(u'forum_user', 'img128',
                      self.gf('django.db.models.fields.files.ImageField')(default='upload_userface/noface_128.gif', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.img32'
        db.delete_column(u'forum_user', 'img32')

        # Deleting field 'User.img128'
        db.delete_column(u'forum_user', 'img128')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NodeRevision.space'
        db.alter_column(u'forum_noderevision', 'space_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['forum.Space']))

        # Changing field 'Node.space'
        db.alter_column(u'forum_node', 'space_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['forum.Space']))

    def backwards(self, orm):

        # Changing field 'NodeRevision.space'
        db.alter_column(u'forum_noderevision', 'space_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['forum.Space']))

        # Changing field 'Node.space'
        db.alter_column(u'forum_node', 'space_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['forum.Space']))
    ...
    models = {
        ...
        'forum.node': {
            ...
            'space': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'access_nodes'", 'null': 'True', 'to': "orm['forum.Space']"}),
        ...
        'forum.noderevision': {
            ...
            'space': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'access_noderevisions'", 'null': 'True', 'to': "orm['forum.Space']"}),
        ...
        'forum.questionsubscription': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 7, 4, 0, 0)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 7, 5, 0, 0)'}),

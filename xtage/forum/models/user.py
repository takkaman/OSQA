...
import logging
from forum.utils.checksnpsid import getIdFullName
...
class User(BaseModel, DjangoUser):
    ...
    img = models.ImageField( upload_to = 'upload_userface/', default='upload_userface/noface.gif')
    img18 = models.ImageField( upload_to = 'upload_userface/', default='upload_userface/noface_18.gif')
    img24 = models.ImageField( upload_to = 'upload_userface/', default='upload_userface/noface_24.gif')
    img32 = models.ImageField( upload_to = 'upload_userface/', default='upload_userface/noface_32.gif')
    img128 = models.ImageField( upload_to = 'upload_userface/', default='upload_userface/noface_128.gif')
    imgset = models.BooleanField(default=False)
    ...
    def _decorated_name(self):
        ...
        if re.match(r'^\s*$', FullName):
            FullName = self.username
        username = smart_unicode(FullName)
    ...
    def save(self, *args, **kwargs):
        ...
        lastN, firstN = getIdFullName(self.username)
        self.first_name = firstN
        self.last_name = lastN

        super(User, self).save(*args, **dict(kwargs, first_name=firstN, last_name=lastN))

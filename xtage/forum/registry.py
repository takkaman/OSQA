...
ui.register(ui.HEADER_LINKS,
            ui.Link(_('FAQ'), ui.Url('faq'), weight=400, name='FAQ',pre_code=lambda u, c: '<li>', post_code=lambda u, c: '</li>'),
            ui.Link(_('About'), ui.Url('about'), weight=300, name='ABOUT',pre_code=lambda u, c: '<li>', post_code=lambda u, c: '</li>'),

            ui.Link(
                    visibility=ui.Visibility.ANONYMOUS,
                    text=_('Login'),
                    url=lambda u, c: reverse('auth_signin'),
                    pre_code=lambda u, c: '<li>',
                    post_code=lambda u, c: '</li>',
                    weight=200, name='LOGIN'),
            ui.Link(
                    visibility=ui.Visibility.AUTHENTICATED,
                    text=_('Logout'),
            ...
            ui.Link(
                    ...
                    url=lambda u, c: u.get_profile_url(),
                    pre_code=lambda u, c: '<li>',
                    post_code=lambda u, c: get_score_badge(u)+'</li>',
                    weight=100, name='ACCOUNT'),

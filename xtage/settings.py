...
# yfhuang added, reset the default django upload file limit from 2.5m (2621440) to 25m
# give the control of size check to view function 
FILE_UPLOAD_MAX_MEMORY_SIZE = 10*2621440
...
#    'snpspv.auth.dpam.backends.PAMBackend',
#    'snpspv.auth.backends.SNPSPVBackend',
